    ...
    if request.method == 'POST':
        ...
        while (flag):
            ...
            if addr != 'N':
                ...
                if 'yes' in say.lower():
                    flag = False  
                    texttospeech("u", file + i)
                else:
                     texttospeech("u said " + say + "this ", file + i)   

            else:
                texttospeech("could not understand what you meant:")
                i = i + str(1)
        addr = addr.strip()
        addr = addr.replace(' ', '')
        addr = addr.lower()
        ...
        try:
            ...
            print(f"Exception: {e}")  # This line will print the exception details to the console
...
def compose_view(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            print(f"Exception during sending email: {e}")
